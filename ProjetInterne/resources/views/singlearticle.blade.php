...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('assets/css/singlearticle.css') }}">
...
<article class="t-content__article-wrapper" data-article-content="">
    ...
    <div class="t-content__dates t-content__dates--reading-time ">
        <p class="m-pub-dates"><span class="m-pub-dates__date">Publié le : <time datetime="2024-03-24T08:00:14+00:00" >23/03/2024 - 09:00</time></span></p>
        <div class="m-from-author">
            <span class="m-from-author__by-label"> Par :</span>
    ...
    <div class="t-content__main-media">
        <figure class="m-figure m-figure--16x9">    
            <img fetchpriority="high" src="{{ asset('assets/images/AI.jpg') }}" alt="" class="m-figure__img lazy">
   ...
   <div class="container mt-5">
    <div class="d-flex justify-content-center row">
        <div class="col-md-8">
            <div class="d-flex flex-column comment-section">
                <div class="bg-white p-2">
                    <div class="d-flex flex-row user-info"><img class="rounded-circle" src="{{ asset('assets/images/comment.jpg') }}" width="40">
        ...
        <div class="d-flex flex-row align-items-start">
            <img class="rounded-circle" src="{{ asset('assets/images/comment.jpg') }}" width="40">
            ...
            <button class="btn btn-outline-primary btn-sm ml-1 shadow-none cancel-reply-btn" type="button"><span class="cancel">Cancel</span></button>
                ...
                <div class="bg-light p-2">
                    ...
                    <div class="mt-2 text-right">
                        ...
                        <button class="btn btn-outline-primary btn-sm ml-1 shadow-none " type="button"><span class="cancel">Cancel</span></button>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row justify-content-center"> 
            ...
            <div class="text-center categorie ">
                ...
                <a href=""><div class="card">
                        ...
                        <img class="card-img-top img-responsive mx-auto d-block" src="{{ asset('assets/images/1.jpg') }}" alt="Card image cap">
            ...
            <div class="text-center categorie">
                ...
                <a href=""><div class="card">
                        ...
                        <img class="card-img-top img-responsive mx-auto d-block" src="{{ asset('assets/images/2.png') }}" alt="Card image cap">
            ...
            <div class="text-center categorie">
                ...
                <a href=""><div class="card">
                        ...
                        <img class="card-img-top img-responsive mx-auto d-block" src="{{ asset('assets/images/3.jpg') }}" alt="Card image cap">
...
<script src="{{ asset('assets/js/singlearticle.js') }}"></script>
</body>
</html>
