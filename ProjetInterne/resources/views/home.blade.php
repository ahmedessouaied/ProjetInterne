...
<body>
  <header>
    ...
    <nav>
      <svg xmlns="http://www.w3.org/2000/svg" class="menu" id="menu-btn" viewBox="0 0 20 20" fill="currentColor">
        <path fill-rule="evenodd" d="M3 5a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1zM3 10a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1zM3 15a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1z" clip-rule="evenodd" />
      </svg>
      <ul class="nav" id="nav">
        <li><svg xmlns="http://www.w3.org/2000/svg" class="close" id="close-btn" viewBox="0 0 20 20" fill="currentColor">
      ...
      <div class="footer-content">
        ...
        <div class="footer-content-column">
          ...
          <div class="footer-call-to-action">
            ...
            <p class="footer-call-to-action-link-wrapper"> <a class="footer-call-to-action-link" href="tel:0124-64XXXX" target="_self"> +216 xx xxx xxx </a></p>
          </div>
        </div>
      ...
      <div class="footer-copyright">
        <div class="footer-copyright-wrapper">
          <p class="footer-copyright-text">
            <a class="footer-copyright-link" href="#" target="_self"> ©2024. | Designed By:Sup'Com Junior Entreprise. | All rights reserved. </a>
          </p>
        </div>
      </div>
    </footer>
